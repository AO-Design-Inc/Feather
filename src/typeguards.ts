...
import {ExecutableType,
	...
	ProposedExecutable,
	CheckingExecutable,
	ExecutableKinds} from './set-functions-interfaces';

declare const ContractError: any;

export const isArweaveAddress = (addy: string):
	addy is ArweaveAddress =>
	/[\w-]{43}/i.test(addy);
export const isCheckingExecutable = (target: ExecutableType):
	target is CheckingExecutable =>
